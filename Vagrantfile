...
default_config_file = "#{File.dirname(__FILE__)}/vm_config.default.yml"
...
vm_ext_conf = YAML.load_file(config_file)
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
    ...
    # configuration step 5: ghost
    config.vm.provision "shell", path: "vagrant/ghost.sh"
